# TON 智能合约开发 — Tact + 蓝图模板

使用 Tact 语言（高级、类似 TypeScript）和 Blueprint 框架进行生产级 TON 智能合约开发。

---

## 项目概述

该模板提供了一个完整的开发环境，用于使用以下方式构建 TON 智能合约：

- **Tact** - TON 的高级智能合约语言（类似于 TypeScript）
- **蓝图** - 现代开发框架
- **TypeScript** - 测试和部署
- **TON SDK** - TON 的 JavaScript 库
- **沙盒** - 本地区块链测试

**Tact 相对于 FunC 的优点：**
- 类似 TypeScript 的语法（更容易学习）
- 内置安全功能（溢出保护、自动序列化）
- 强大的打字系统
- 更少的样板代码
- 仍然编译为高效的 FunC 代码

**用例：** Jettons、NFT、DeFi、钱包、DAO、游戏
...
- [Tact 示例](https://tact-by-example.org/)
- [TON 文档](https://docs.ton.org/)
- [蓝图](https://github.com/ton-org/blueprint)
